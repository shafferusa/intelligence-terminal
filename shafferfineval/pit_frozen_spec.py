...
STILL_BLOCKED: dict[str, Any] = {
    "the_diagnostic_replay_itself": (
        ...
        "instruction. THE FOUR-DATE PILOT HAS NOW RUN (2026-09-23, report "
        "section 5d), on the owner's work order, as four per-date invocations "
        "into four disposable databases outside the repository: 30,308 "
        "entity-dates in 61 minutes for 405 MB at 13,358 B/entity-date, WAL peak "
        "15.4 MB, peak commit 318-333 MiB, free-space low-water 12.42 GiB, every "
        "checkpoint clean, the pagefile peak unmoved, the main store "
        "byte-identical and this freeze intact before and after. Score density "
        "38.5%; only 3.1% of entity-dates carry all four blocks; "
        "ev_ebitda_supplement produced 2 of 30,308. The binding constraint is "
        "store coverage, not any model rule: pit_listing covers 2,542 of 16,890 "
        "entities, so 65-75% of live filers have no listing at all and "
        "price-conditional availability is capped near a third of the universe. "
        "What remains is the 165-DATE GRID, which runs only on the owner's word. "
        "No authorisation for the grid exists."),
