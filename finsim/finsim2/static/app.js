...
(() => {
  ...
  function hedgePanel(el, ana, o = {}) {
    ...
    el.innerHTML = `${warn}
      ...
      <div class="tbl-wrap"><table class="wraph"><thead><tr><th class="l">Product</th><th>Shaffer Hedge Score<br><span style="text-transform:none;letter-spacing:0;font-weight:400">judged on ${esc(((el_[0] || {}).judged_on) || 'variance')}</span></th><th>Unit-rule size</th><th>Notional</th><th>Est. cost</th><th>Exp. variance cut</th><th>Basis ($/day)</th><th>ADV use</th><th>Hist. variance cut</th><th>Hist. tail cut</th><th class="l">E·Q·L·R·B·T</th></tr></thead><tbody>
